 ...
 * Purpose: Tab switching, form handling, order history, and avatar management.
 */
...
const ProfileApp = {
    ...
    setupEventListeners() {
        window.onclick = (event) => {
            ...
            if (event.target == modal)        this.closeOrderModal();
            if (event.target == reorderModal) this.closeReorderModal();
        };
    },
...
// ── GLOBAL EXPOSURE (REQUIRED FOR INLINE ONCLICKS) ───────────────────────────
