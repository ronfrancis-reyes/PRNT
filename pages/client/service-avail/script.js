...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function checkStep1Validity() {
        ...
        const isValid = serviceChosen && quantityValid && (!formatVisible || formatChosen);
    ...
    function checkStep3Validity() {
        ...
        const isDelivery = selectedReceivingOption === 'delivery' && deliveryAddress.value.trim() !== '';
    ...
    function populateSummary() {
        ...
        if (formatContainer.style.display !== 'none' && formatSelect.value) {
            ...
            summaryFormat.textContent = formatSelect.options[formatSelect.selectedIndex].text;
        } else {
        ...
        let receivingText = selectedReceivingOption === 'pickup' ? 'Store Pick-up' : 'Delivery';
