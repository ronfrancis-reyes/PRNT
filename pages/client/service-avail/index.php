                ...
                <div class="card flow-step animate-slide" id="configStep">
                    ...
                    <div class="form-group" style="margin-bottom:1.25rem;">
                        ...
                        <select id="serviceFormat" onchange="handleFormatChange()"
                            ...
                            <option value="id_card">ID / Card Printing</option>
                            <option value="booklet">Booklet Binding</option>
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:1.25rem;margin-bottom:1.25rem;">
                        <div class="form-group">
                            <label for="printType" style="display:block;margin-bottom:0.5rem;font-weight:600;font-size:0.9rem;">Print
                                Type</label>
                            <select id="printType" onchange="updatePrice()"
                                style="width:100%;padding:0.85rem;border:1px solid var(--border);border-radius:var(--radius);outline:none;background:white;">
