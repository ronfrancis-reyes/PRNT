...
<body>
  ...
  <!-- ===================================================================
       ...
       The navbar is intentionally excluded from this page.
       This spacer preserves the layout offset for the fixed navbar height.
       ── TO RESTORE: replace this div with:
              ...
              <div class="form-group">
                ...
                <div class="select-wrapper">
                  <select id="serviceSelect" onchange="handleServiceChange()" disabled aria-label="Select print service">
                    ...
                    <option value="sticker">Sticker Print</option>
                  </select>
  ...
  <!-- ===================================================================
       FOOTER PLACEHOLDER SPACE
       The footer is intentionally excluded from this page.
       ── TO RESTORE: replace this div with:
  ...
  <div class="modal-overlay" id="editItemModal" aria-hidden="true" style="display:none;">
    <div class="modal-content" style="max-width: 440px;">
      ...
      <div class="modal-body">
        ...
        <div class="price-strip price-strip-enlarged" id="editPriceStrip">
          <div class="price-info">
            <strong>Estimated Price</strong>
            <span>per print service</span>
          </div>
