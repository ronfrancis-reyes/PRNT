...
const PRICING = {
  photo:    { bw: 5.0,  color: 8.0  },
  document: { bw: 1.0,  color: 3.5  },
  sticker:  { bw: 15.0, color: 25.0 }
};
...
const FORMAT_SIZES = {
  ...
  sticker:  [
    { value: 'a4_sheet', label: 'A4 Sheet'        },
    { value: 'per_pc',   label: 'Per Piece (Sm)'  }
  ]
};
...
function addToOrder() {
  ...
  const serviceLabel = { photo: 'Photo Print', document: 'Document Print', sticker: 'Sticker Print' }[service] || service;
