      ...
      <div class="table-card">
        <table>
          ...
          <tbody id="tableBody">
            ...
            <!-- FOR TESTING -->
            <tr
              data-order-id="ORD-1234"
              data-date="Mar 24, 2026"
              data-customer="John Smith"
              data-email="john.smith@email.com"
              data-phone="09171234567"
              data-service="Business Cards"
              data-file="business_card.pdf"
              data-print-type="Colored"
              data-paper-size="A4"
              data-copies="50"
              data-receiving="Delivery"
              data-address="Activity Center"
              data-notes="Enter Additional Notes Here."
              data-amount="₱45.00"
            ...
            <tr
              data-order-id="ORD-1235"
              data-date="Mar 24, 2026"
              data-customer="Sarah Johnson"
              data-email="sarah.j@email.com"
              data-phone="09281234567"
              data-service="Flyers (A4)"
              data-file="flyer_design.pdf"
              data-print-type="Colored"
              data-paper-size="A4"
              data-copies="100"
              data-receiving="Pick-up"
              data-address="E-Library"
              data-notes="Double sided printing please."
              data-amount="₱120.00"
            ...
            <tr
              data-order-id="ORD-1236"
              data-date="Mar 24, 2026"
              data-customer="Mike Brown"
              data-email="mike.brown@email.com"
              data-phone="09391234567"
              data-service="Posters (A2)"
              data-file="poster.pdf"
              data-print-type="Colored"
              data-paper-size="A2"
              data-copies="10"
              data-receiving="Delivery"
            ...
            <tr
              data-order-id="ORD-1237"
              data-date="Mar 24, 2026"
              data-customer="Emma Davis"
              data-email="emma.davis@email.com"
              data-phone="09501234567"
              data-service="Brochures"
              data-file="brochure.pdf"
              data-print-type="Colored"
              data-paper-size="A4"
              data-copies="200"
              data-receiving="Pick-up"
              data-address="CoED"
              data-notes="Tri-fold layout."
              data-amount="₱200.00"
              data-status="Completed">
            ...
            <tr
              data-order-id="ORD-1238"
              data-date="Mar 24, 2026"
              data-customer="James Wilson"
              data-email="james.w@email.com"
              data-phone="09611234567"
              data-service="Banners"
              data-file="banner_design.pdf"
              data-print-type="Colored"
              data-paper-size="A1"
              data-copies="5"
              data-receiving="Delivery"
              data-address="Carpio Hall"
              data-notes="Please use tarpaulin material."
              data-amount="₱350.00"
              data-status="Processing">
